...
ROADMAP_STEPS = [
    ...
    {"num": 3,  "name": "Performance Dashboard",              "status": "COMPLETE", "date": "Mar 7, 2026"},
    {"num": 4,  "name": "Kalshi Rewards Scanner",             "status": "COMPLETE", "date": "Mar 7, 2026"},
    ...
    {"num": 16, "name": "Kalshi WebSocket",                   "status": "COMPLETE", "date": "Mar 1, 2026"},
    {"num": 20, "name": "Skill Vetting Protocol",             "status": "COMPLETE", "date": "Mar 1, 2026"},
    {"num": 21, "name": "Cemini SKILL.md",                    "status": "COMPLETE", "date": "Mar 7, 2026"},
    {"num": 24, "name": "Visual Crossing Weather",            "status": "COMPLETE", "date": "Mar 2, 2026"},
