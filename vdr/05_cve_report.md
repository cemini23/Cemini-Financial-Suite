...
| PYSEC-2023-228 (BIT-pip-2023-5752) | pip | 22.0.2 | 23.3 | When installing a package from a Mercurial VCS URL, e.g. `pip install hg+...`, with pip prior to v23.3, the specified Me... |
...
| CVE-2024-6345 (GHSA-cx63-2mw6-8hw5) | setuptools | 59.6.0 | 70.0.0 | A vulnerability in the `package_index` module of pypa/setuptools versions up to 69.1.1 allows for remote code execution ... |
| PYSEC-2022-43012 (BIT-setuptools-2022-40897) | setuptools | 59.6.0 | 65.5.1 | Python Packaging Authority (PyPA)'s setuptools is a library designed to facilitate packaging Python projects. Setuptools... |
...
| PYSEC-2022-160 (GHSA-rv6r-3f5q-9rgx) | twisted | 22.1.0 | 22.2.0 | Twisted is an event-based framework for internet applications, supporting Python 3.6+. Prior to 22.2.0, Twisted SSH clie... |
| PYSEC-2022-195 (CVE-2022-24801) | twisted | 22.1.0 | 22.4.0 | Twisted is an event-based framework for internet applications, supporting Python 3.6+. Prior to version 22.4.0rc1, the T... |
